    ...
    <header className="sticky top-0 z-50 flex items-center justify-between px-5 py-4 bg-[#0c1324] shadow-[0_8px_32px_rgba(7,13,31,0.6)] border-b border-white/5">
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col leading-tight">
          <span className="font-bold italic tracking-tighter text-xl text-[#51e1a5]">Zarmani108</span>
          <div className="flex items-center gap-1">
            <span className="text-[10px] tracking-widest uppercase text-white/50">Verified User: AK</span>
            <span
